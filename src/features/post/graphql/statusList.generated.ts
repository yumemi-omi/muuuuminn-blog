...
useLifeProjectStatusListQuery.getKey = (variables?: LifeProjectStatusListQueryVariables) =>
  variables === undefined ? ["LifeProjectStatusList"] : ["LifeProjectStatusList", variables];
export const useInfiniteLifeProjectStatusListQuery = <
  TData = LifeProjectStatusListQuery,
  TError = unknown,
>(
  pageParamKey: keyof LifeProjectStatusListQueryVariables,
  variables?: LifeProjectStatusListQueryVariables,
  options?: UseInfiniteQueryOptions<LifeProjectStatusListQuery, TError, TData>,
) => {
  return useInfiniteQuery<LifeProjectStatusListQuery, TError, TData>(
    variables === undefined
      ? ["LifeProjectStatusList.infinite"]
      : ["LifeProjectStatusList.infinite", variables],
    (metaData) =>
      fetcher<LifeProjectStatusListQuery, LifeProjectStatusListQueryVariables>(
        LifeProjectStatusListDocument,
...
useInfiniteLifeProjectStatusListQuery.getKey = (variables?: LifeProjectStatusListQueryVariables) =>
  variables === undefined
    ? ["LifeProjectStatusList.infinite"]
    : ["LifeProjectStatusList.infinite", variables];
